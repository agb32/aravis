...
#define	ARV_GV_DEVICE_GVCP_TIMEOUT_MS_DEFAULT	1000//increased from 500 by agb for EVT.
#define	ARV_GV_DEVICE_HEARTBEAT_PERIOD_US	1000000//increased from 1000000 by agb.  But 1s seems necessary, so reverted.
