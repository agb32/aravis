...
#This does multicasting with the bobcat, but only as a subscriber.
...
cameraParams[10*ncam+2+(namelen+3)//4+1:11*ncam+2+(namelen+3)//4+1]=[0]+[0]*(ncam-1)#multicastMaster
...
control={
    ...
    "camerasOpen":1,
    "camerasFraming":1,
    "cameraName":"libcamAravisMultiClientTest.so",#"camfile",
