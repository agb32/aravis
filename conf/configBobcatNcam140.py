...
"""
  ...
  //recordTimestamp
"""
camList=["Imperx, inc.-110594","Imperx, inc.-110240","Imperx, inc.-110323","Imperx, inc.-110325"][:ncam]
...
cameraParams[2*ncam:3*ncam]=(224-npxlx[0])//2#254#x offset
cameraParams[3*ncam:4*ncam]=(480-npxly[0])//2#174#y offset
...
#camCommand="TriggerMode=Off;ProgFrameTimeEnable=false;GevSCPSPacketSize=8000;ProgFrameTimeAbs=20000;TriggerType=Fast;ExposureTimeRaw=100;ExposureMode=Off;"#;"
camCommand="GevSCPSPacketSize=9000;CenterScanMode=true;ExposureTimeRaw=2;TriggerType=Standard;ProgFrameTimeEnable=false;CameraSpeed=OverClocked;"
