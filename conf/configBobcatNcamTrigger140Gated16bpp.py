...
camCommand="TriggerMode=Off;PixelSize=Bpp12;BinningHorizontal=x1;BinningVertical=x1;ProgFrameTimeEnable=false;GevSCPSPacketSize=9000;ProgFrameTimeAbs=2000;TriggerType=FrameAccumulation;ExposureTimeRaw=100;ExposureMode=Off;TriggerNumPulses=57;CenterScanMode=true;TriggerMode=On;"
